function MOTLoading_Fluorescence()
...
directoryS='Z:\Users\paul\Data\University stuff\CQT\Data\140122 ChipMOT Loading\140122\Scripts';
directoryR='Z:\Users\paul\Data\University stuff\CQT\Data\140122 ChipMOT Loading\140122\Images\MatlabProcessed';
...
startTS = '140122_1137_52';
stopTS = '140122_1159_09';
...
for i=1:imageN;
    ...
    %writeAnalysisResultsToFile('MOT LoadingRate.txt', timestamp, resultsArray, directoryR);
end

figure(1)
plot(loadingTime, atomNumber, 'o');
figure(2)
plot(loadingTime, abs(sizeX), 'o');
figure(3)
plot(loadingTime, abs(sizeY), 'o');
