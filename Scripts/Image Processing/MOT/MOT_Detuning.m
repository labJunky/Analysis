...
directoryO='Z:\Users\paul\Data\University stuff\CQT\Data\140204 Chip MOT detuning\140204\Images\ObjectImages\';
directoryRef='Z:\Users\paul\Data\University stuff\CQT\Data\140204 Chip MOT detuning\140204\Images\RefImages\';
directoryBg='Z:\Users\paul\Data\University stuff\CQT\Data\140204 Chip MOT detuning\140204\Images\BGImages\';
directoryS='Z:\Users\paul\Data\University stuff\CQT\Data\140204 Chip MOT detuning\140204\Scripts\';
directoryProcessed='Z:\Users\paul\Data\University stuff\CQT\Data\140204 Chip MOT detuning\140204\';
...
startTS = '140204_1755_05';
stopTS = '140204_1802_22';
...
for i=1:imageN;
    ...
    ROIy = [146:512]; % This is labeled signalx in the settings file
    ROIx = [680:1040]; % This is labeled signaly in the settings file
...
% 
    ...
    MOT_detuning(i) = readScriptParameter(scriptDoc, parameterName)-17.2; % in MHz (laser is already 17.2 MHz detuned from 2-3 transition)
    
    resultsArray = [MOT_detuning(i), atomNumber(i), sizeX(i), sizeY(i)];
    %writeAnalysisResultsToFile('MOT Detuning.txt', timestamp, resultsArray, directoryProcessed);
end