function [atomNumber, sizeX, sizeY] = AbsorptionImage(atoms, laser, bg, imagePath)
...
motImageFinal = objImg - bg;
backgroundImageFinal = refImg - bg;
